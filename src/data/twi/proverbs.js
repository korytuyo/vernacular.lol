/**
 * Twi (Akan) Proverbs Collection
 * Authentic ebe from Ashanti cultural heritage
 */
...
export const twiProverbs = [
  ...
  {
    id: 4,
    twi: "Wɔbɔ a ɔno na ɔwɔ no.",
    english: "The one who builds is the one who has it.",
    literal: "If one builds it, then one has it.",
    context: "This proverb speaks to ownership, legacy, and creative effort in Akan culture. It emphasizes that what you create through your own labor belongs to you. This reflects the Ashanti concept of property rights tied to personal enterprise, visible in craft traditions like kente weaving and gold smithing.",
    category: "wisdom",
    difficulty: "intermediate",
    lessonLink: 2
  },
...
export const twiProverbCategories = [
  {
    id: "wisdom",
    label: "Wisdom"
  },
