  ...
  return (
    <div className={`bg-white rounded-2xl p-5 border transition-all ${
      ...
      <div className="flex items-start justify-between mb-3">
        ...
        {scenario.locked && <Lock className="w-4 h-4 text-gray-400" />}
      </div>

      <h3 className="text-base font-semibold text-gray-900 mb-1">{scenario.title}</h3>
      <p className="text-sm text-gray-500 mb-3">{scenario.description}</p>

      <div className="bg-gray-50 rounded-xl p-3 mb-4">
        <p className="text-xs text-gray-400 font-semibold mb-1">YOU'LL TALK TO:</p>
        <p className="text-sm text-gray-700">{scenario.aiRole.split(',')[0]}</p>
      </div>
...
export default function Practice() {
  return (
    <div className="min-h-screen pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
      <div className="mb-10">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">AI Conversation Practice</h1>
        <p className="text-gray-600">
          Practice Yoruba in realistic scenarios with AI characters. Each conversation builds on your lessons.
        </p>
      </div>
