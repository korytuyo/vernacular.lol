    ...
    <div className="min-h-screen flex items-center justify-center px-4 pt-16 bg-gray-50 dark:bg-slate-950">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 dark:text-slate-400 mt-2">Welcome back. Continue your journey.</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-gray-200 dark:border-slate-700 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 bg-green-700 dark:bg-green-600 text-white font-semibold rounded-xl hover:bg-green-800 dark:hover:bg-green-700 transition-colors text-sm disabled:opacity-50"
            >
        ...
        <p className="text-center text-sm text-gray-500 dark:text-slate-400 mt-6">
          New here?{' '}
          <Link to="/signup" className="text-green-700 dark:text-green-400 font-semibold hover:text-green-800 dark:hover:text-green-300 no-underline">
            Create an account
          </Link>
        </p>
      </div>
